...
class Packet:
    def __init__(self, src_ip, dest_ip, dest_port,met):
        ...
        self.reserved = 0x0
        self.ns, self.cwr, self.ece, self.urg,  self.psh, self.rst, = 0x0, 0x0, 0x0, 0x0, 0x0, 0x0
        #############
        if(met==0):
            self.ack, self.syn, self.fin = 0x1, 0x0, 0x0
        if (met == 1):
            self.ack, self.syn, self.fin = 0x0, 0x1, 0x0
        if (met == 2):
            self.ack, self.syn, self.fin = 0x0, 0x0, 0x1
        #############
